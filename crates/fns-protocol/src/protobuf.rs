...
impl From<crate::NoteSyncCheckRequest> for NoteSyncCheckRequest {
    fn from(value: crate::NoteSyncCheckRequest) -> Self {
        Self {
            path: value.path,
...
impl From<crate::NoteSyncDelNote> for NoteSyncDelNote {
    fn from(value: crate::NoteSyncDelNote) -> Self {
        Self {
            path: value.path,
            path_hash: value.path_hash,
        }
...
impl From<crate::FileSyncCheckRequest> for FileSyncCheckRequest {
    fn from(value: crate::FileSyncCheckRequest) -> Self {
        Self {
            path: value.path,
            path_hash: value.path_hash,
            content_hash: value.content_hash,
...
impl From<crate::FileSyncDelFile> for FileSyncDelFile {
    fn from(value: crate::FileSyncDelFile) -> Self {
        Self {
            path: value.path,
            path_hash: value.path_hash,
        }
...
impl From<crate::SettingSyncCheckRequest> for SettingSyncCheckRequest {
    fn from(value: crate::SettingSyncCheckRequest) -> Self {
        Self {
            path: value.path,
            path_hash: value.path_hash,
            content_hash: value.content_hash,
...
impl From<crate::SettingSyncDelSetting> for SettingSyncDelSetting {
    fn from(value: crate::SettingSyncDelSetting) -> Self {
        Self {
            path: value.path,
            path_hash: value.path_hash,
        }
...
impl From<crate::FolderSyncCheckRequest> for FolderSyncCheckRequest {
    fn from(value: crate::FolderSyncCheckRequest) -> Self {
        Self {
            path: value.path,
            path_hash: value.path_hash,
            mtime: value.mtime,
...
impl From<crate::FolderSyncDelFolder> for FolderSyncDelFolder {
    fn from(value: crate::FolderSyncDelFolder) -> Self {
        Self {
            path: value.path,
            path_hash: value.path_hash,
        }
