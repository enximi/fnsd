use crate::core::{ContentHash, RemoteMillis, VaultPath};
use crate::hash::file_content_hash;
use crate::protocol::FileChunkFrame;
use crate::sync::plan::FileUpload;
use crate::vault::fs::VaultFs;

use crate::sync::transfer::{Result, valid_positive_usize};
