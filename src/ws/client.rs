...
impl WebSocketClient {
    ...
    fn decode_binary_event(&self, bytes: &Bytes) -> Result<WsEvent> {
        ...
        if frame.prefix_str() == crate::protocol::PROTOBUF_BINARY_PREFIX {
...
pub struct ClientDescriptor {
    ...
    pub is_win: bool,
    pub is_linux: bool,
    pub offline_sync_strategy: Option<crate::protocol::OfflineSyncStrategy>,
    pub protobuf: bool,
}
